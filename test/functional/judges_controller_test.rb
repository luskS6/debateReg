...
class JudgesControllerTest < ActionController::TestCase
  ...
  test "should create judge" do
    assert_difference('Judge.count') do
      post :create, judge: { debate_exp: @judge.debate_exp, jfirstName: @judge.jfirstName, jlastName: @judge.jlastName, school_id: @judge.school_id }
    end
  ...
  test "should update judge" do
    put :update, id: @judge, judge: { debate_exp: @judge.debate_exp, jfirstName: @judge.jfirstName, jlastName: @judge.jlastName, school_id: @judge.school_id }
    assert_redirected_to judge_path(assigns(:judge))
  end
