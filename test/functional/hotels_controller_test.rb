...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { fourRooms: @hotel.fourRooms, school_id: @hotel.school_id, twoRooms: @hotel.twoRooms }
    end
  ...
  test "should update hotel" do
    put :update, id: @hotel, hotel: { fourRooms: @hotel.fourRooms, school_id: @hotel.school_id, twoRooms: @hotel.twoRooms }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
